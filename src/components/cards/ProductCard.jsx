...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="bg-white border border-[rgba(0,0,0,0.2)] border-solid rounded-[20px] overflow-hidden flex flex-col w-full max-w-[343px]">
      ...
      <div className="p-6 pb-8 flex flex-col items-center gap-3">
        ...
        <p className="font-['Cyntho_Next:Medium',sans-serif] text-[rgba(0,0,0,0.5)] text-lg">Park Lank Hotel</p>

        <p className="font-['Cyntho_Next:Medium',sans-serif] text-[rgba(236,54,43,0.5)] text-lg">Restaurant</p>
