...
export default function CreaterestaurantModal({ onClose, setrestaurantsList }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setrestaurantsList(prev => [...prev, res.data.data])
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            ...
            rounded-full hover:bg-black/10 transition"
                ...
                <form onSubmit={handleSubmit}
                    ...
                    <input placeholder="address" value={address} onChange={e => setaddress(e.target.value)} className={customInputStyles} />
                    <input type="tel" placeholder="phoneNumber" value={phoneNumber} onChange={e => setphoneNumber(e.target.value)} className={customInputStyles} />
                    <input type="number" placeholder="rating" value={rating} onChange={e => setrating(e.target.value)} className={customInputStyles} />
